    ...
    <div className="border rounded-lg p-4 bg-white">
      <div className="flex items-start justify-between">
        ...
        <div className="flex flex-col space-y-3 ml-6">
          ...
          <Button variant="outline" size="sm" className="min-w-[140px]">View Job Summary</Button>
          {item.status === 'upcoming' && (
            <>
              <Button variant="primary" size="sm" className="min-w-[140px]">Confirm Attendance</Button>
              <Button variant="ghost" size="sm" className="min-w-[140px]">Message Client</Button>
            </>
          )}
          {item.status === 'in_progress' && (
            <>
              <Button variant="outline" size="sm" className="min-w-[140px]">Upload Location Proof</Button>
              <Button variant="primary" size="sm" className="min-w-[140px]">Submit Completion Report</Button>
            </>
          )}
          {item.status === 'completed' && (
            <>
              <Button variant="ghost" size="sm" className="min-w-[140px]">View Report</Button>
              <Button variant="outline" size="sm" className="min-w-[140px]">Contact Support</Button>
            </>
          )}
        </div>
      </div>
